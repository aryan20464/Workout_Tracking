...
```
<p> In the above output the section "Overall Statistics" has some values for outputs, the accuracy is mentioned there it is 0.9932. So the model fitted here has an accuracy of 99.32% and the out of sample error could be calculated manually by subtracting the accuracy from 1. It is (1-0.9932  = 0.01087511).
</p>
<p>The Details of the model fitted:</p>
<p>Accuracy : 99.32%</p>
<p>Out of Sample error : 0.01087511</p>
